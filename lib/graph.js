...
import { storeToSparql, sleep, insertQueryTemplate } from './utils';
...
export async function writeTriplesToGraph(
  ...
  for (let page = 0; page < pages; page++) {
    ...
    const makeInsertQueryWithCompactTriples = insertQueryTemplate(graph);
    const queryStr = makeInsertQueryWithCompactTriples(batch);
    try {
